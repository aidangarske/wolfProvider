...
WOLFSSL_FIPS_CONFIG_CFLAGS=${WOLFSSL_CONFIG_CFLAGS:-"-I${OPENSSL_INSTALL_DIR}/include -DWOLFSSL_DEBUG_ASN_TEMPLATE -DWOLFSSL_ENCRYPTED_KEYS -DWOLFSSL_OLD_OID_SUM"}
